...
* To represent numbers in thousands can use "commas" or "spaces", for example 10,000 or 5,000,321 that can be combined with points to set a valid number 10,592.76. 
